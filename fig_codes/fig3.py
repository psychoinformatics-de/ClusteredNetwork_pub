...
def do_plot(params,file_name,axes=None,redo = False,plot = True,markersize = 0.5,
            ...
            legend = False,current_limits = [-15,18],
            voltage_limits = [-20,42],ylabel = False,
            rate_ticks = [],V_ticks = [],I_ticks = []):
...
gs = pylab.GridSpec(nrows,ncols,top=0.95,bottom=0.08,
                    ...
                    height_ratios = [1.8,hspace,0.7,hspace,1.1,hspace,.7])
x_label_val = -0.17
...
for setno,setting in enumerate(settings):
    ...
    do_plot(params,file_name=file_name,redo = False,axes = axes[setno],box_color = 'r',cmap = 'Greys',legend = legend,ylabel = ylabel,
